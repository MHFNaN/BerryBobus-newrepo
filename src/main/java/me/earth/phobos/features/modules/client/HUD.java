...
public class HUD
    ...
    private final Setting<String> spoofGreeter = this.register(new Setting<Object>("GreeterName", "weaponizeautism", v -> this.greeter.getValue() == Greeter.CUSTOM));
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        switch (this.watermark.getValue()) {
            ...
            case EARTH: {
                this.renderer.drawString("Monke" + (this.modeVer.getValue() ? " v1.0" : ""), 2.0f, 2.0f, (this.rolling.getValue() && this.rainbow.getValue()) ? this.colorMap.get(2) : this.color, true);
                break;
            }
            case CUSTOM: {
