...
public class ServerModule
    ...
    public Setting<String> ip = this.register(new Setting<String>("SpobosBypass", "0.0.0.0.0"));
    ...
    public ServerModule() {
        super("PingBypass", "Manages Skobos internal Server", Module.Category.CLIENT, false, false, true);
        instance = this;
    }
