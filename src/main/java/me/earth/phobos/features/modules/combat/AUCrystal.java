...
import cascade.event.events.PacketEvent.Receive;
import cascade.event.events.PacketEvent.Send;
import cascade.features.modules.Module;
import cascade.features.modules.Module.Category;
...
import cascade.util.EntityUtil.SwingType;
...
public class AutoCrystalRewrite extends Module {
   ...
   public AutoCrystalRewrite() {
      super("AUCrystal", Category.COMBAT, "Zprestige sucks ass I stole his code!");
